...
_SPEECHTOTEXT = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    output_type=_SPEECHOPERATION,
    serialized_options=b'\202\323\344\223\002\036\022\034/v1/speech_operations/{name}',
  ),
])
